...
<t:genericpage>
  <jsp:body>
    <div class="content">
      <h3>Welcome to Piece Of Cake!</h3>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Piece Of Cake's Website.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Piece Of Cake if you do not agree to take
      ...
      <p>
        Unless otherwise stated, Piece Of Cake and/or its licensors own the
        intellectual property rights for all material on Piece Of Cake. All
        intellectual property rights are reserved. You may access this from
        Piece Of Cake for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Piece Of Cake</li>
        <li>Sell, rent or sub-license material from Piece Of Cake</li>
        <li>Reproduce, duplicate or copy material from Piece Of Cake</li>
        <li>Redistribute content from Piece Of Cake</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Piece Of Cake does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Piece Of Cake,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Piece Of Cake shall not be liable
      ...
      <p>
        Piece Of Cake reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Piece Of Cake a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Piece Of Cake; and (d) the link is
      ...
      <p>
        ...
        e-mail to Piece Of Cake. Please include your name, your organization name,
      ...
      <p>
        No use of Piece Of Cake's logo or other artwork will be allowed for linking
